System.config({
  ...
  map: {
    ...
    "npm:emailjs-tcp-socket@1.0.2": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "cluster": "github:jspm/nodelibs-cluster@0.1.0",
      "http": "github:jspm/nodelibs-http@1.7.1",
      "net": "github:jspm/nodelibs-net@0.1.2",
      "node-forge": "npm:node-forge@0.6.41",
    ...
    "npm:esmangle@1.0.1": {
      ...
      "esprima": "npm:esprima@1.1.1",
      "esshorten": "npm:esshorten@1.1.1",
      "estraverse": "npm:estraverse@1.5.1",
      "esutils": "npm:esutils@1.0.0",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "optionator": "npm:optionator@0.3.0",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "source-map": "npm:source-map@0.1.43",
      "systemjs-json": "github:systemjs/plugin-json@0.1.2"
    ...
    "npm:forge@2.3.0": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "fu": "npm:fu@0.1.0",
      "jshintify": "npm:jshintify@0.1.0",
      "mangleify": "npm:mangleify@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
